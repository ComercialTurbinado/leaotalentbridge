      ...
      <div className={styles.pagamentoContainer}>
        ...
        <div className={styles.errorContainer}>
          ...
          <div className={styles.errorSolutions}>
            ...
            <ul>
              <li>Verifique os dados do seu cartão e tente novamente</li>
              <li>Tente usar outro método de pagamento</li>
              <li>Entre em contato com seu banco para mais informações</li>
              <li>Se o problema persistir, entre em contato conosco</li>
            </ul>
          </div>

          <div className={styles.errorActions}>
            <Link href="/candidato/pagamento" className="btn btn-primary btn-large">
              <GrRefresh size={20} />
              Tentar Novamente
            </Link>
            <a 
            ...
            <Link href="/candidato/dashboard" className="btn btn-ghost btn-large">
              Voltar ao Dashboard
            </Link>
          </div>
        </div>
