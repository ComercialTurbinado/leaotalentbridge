...
function CandidatoPagamentoContent() {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (data.data.qrCode || data.data.qrCodeText) {
        ...
        router.push(`/candidato/pagamento/pendente?payment_id=${data.data.paymentId}`);
        ...
        router.push(`/candidato/pagamento/processar?orderId=${orderId}&paymentId=${data.data.paymentId}`);
