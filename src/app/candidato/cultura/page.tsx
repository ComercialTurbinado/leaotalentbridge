  ...
  const cultureSections: CultureSection[] = [
    {
      ...
      content: {
        ...
        keyPoints: [
          'Os EAU são compostos por 7 emirados: Abu Dhabi, Dubai, Sharjah, Ajman, Ras Al Khaimah, Fujairah e Umm Al Quwain',
        ...
        tips: [
          ...
          'Seja respeitoso durante o mês do Ramadã',
    ...
    },
    {
      ...
      description: 'Protocolos e comportamentos adequados para o ambiente corporativo nos EAU',
      icon: <GrBriefcase size={24} />,
      color: '#10B981',
      readTime: 20,
      isCompleted: completedSections.includes('business'),
      content: {
        overview: 'O ambiente empresarial nos EAU combina tradições árabes com práticas internacionais modernas. O respeito hierárquico, a paciência nas negociações e a construção de relacionamentos são elementos fundamentais.',
        keyPoints: [
    ...
    },
    {
      ...
      isCompleted: false,
      content: {
        overview: 'A comunicação nos EAU valoriza o respeito, a diplomacia e a construção de consenso. O estilo indireto é comum, e é importante ler nas entrelinhas e demonstrar paciência.',
        keyPoints: [
        ...
        tips: [
          ...
          'Demonstre interesse genuíno pelas opiniões dos outros',
    ...
    },
    {
      ...
      isCompleted: false,
      content: {
        overview: 'Os locais de trabalho nos EAU são multiculturais, com profissionais de todo o mundo. O respeito pela diversidade, combinado com valores árabes tradicionais, cria um ambiente único.',
        keyPoints: [
          ...
          'Horários de trabalho variam durante o Ramadã',
    ...
    },
    {
      ...
      isCompleted: false,
      content: {
        overview: 'A vida social nos EAU gira em torno da hospitalidade árabe e eventos profissionais. Construir uma rede sólida é essencial para o sucesso profissional e pessoal.',
        keyPoints: [
        ...
        tips: [
          ...
          'Demonstre interesse genuíno por outras culturas'
        ]
      }
    },
    {
      ...
      isCompleted: false,
      content: {
        overview: 'Aspectos práticos da vida diária nos EAU, desde transporte até costumes sociais, que facilitarão sua adaptação e integração na sociedade local.',
        keyPoints: [
          'Transporte público é eficiente, especialmente o metrô de Dubai',
        ...
        tips: [
          ...
          'Tenha sempre documento de identificação com você',
