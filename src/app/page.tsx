  ...
  return (
    <div className={styles.homePage}>
      ...
      <section id="beneficios" className={`section ${styles.benefitsSection}`}>
        <div className="container">
          <AnimatedHeading
            title="Por que Escolher a Leao Talent Bridge?"
        ...
        <div className="container">
          <div className="grid grid-2">
            <div className={styles.aboutContent}>
              <AnimatedHeading
                title="Sobre a Leao Talent Bridge"
                level={2}
          ...
          <div className={styles.footerContent}>
            <div className={styles.footerLogo}>
              <Image 
                ...
                height={24}
              />
              <span>Leao <span className="text-gold">Careers</span></span>
            </div>
            ...
            <div className={styles.footerCopyright}>
              <p>&copy; 2024 Leao Careers. Todos os direitos reservados.</p>
            </div>
          </div>
        </div>
      </footer>
